...
var coverStyle={
  ...
  <div style={sectionStyle}>
    ...
    <div  style={{maxWidth:'600px',height:'300px',border:"1px solid #cccccc30",margin:'auto',position:'absolute',top:'0',right:'0',bottom:'0',left:'0',display:"flex",flexDirection:'column',alignContent:'center'}}>
    <Card title="消防车辆保养管理系统" id="logCard"  style={{backgroundColor:'#f0f5ff50',borderColor:'#87e8de',fontSize:30}}  >
    <Form 
   
    //  style={{maxWidth:500,height:232}}
      {...layout}
      name="basic"
      form={form}
    >
      ...
      <Form.Item label="验证码"  extra="验证码全部为小写" >
        <Row gutter={8}>
          <Col span={12}>
            <Form.Item
              name="captcha"
          ...
          <Col span={12}>
            <Button  style={{width:'100%',paddingTop:0,display:"flex",flexDirection:"column",alignItems:"center"}}  border="0"
            size="large"
            id="bt"
 ...
 onClick={()=>{
   ...
   登录
        ...
        <Link to='/Regist' style={{marginLeft:35,marginRight:30}}>立即注册</Link>
